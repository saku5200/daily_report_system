...
<input type="text" name="${AttributeConst.EMP_CODE.getValue()}"value="${employee.name}" />
<br /><br />
<label for="${AttrivuteConst.EMP_PASS.getValue() }}">パスワード</label><br />
<input type="password" name="%{AttributeConst.EMP_PASS.getValue()}" />
<br /><br />

<label for="${AttributeConst.EMP_ADMIN_FLG.getValue() }">権限</label><br />
<select name="${AttributeConst.ROLE_ADMIN.getIntegerValue() }">
